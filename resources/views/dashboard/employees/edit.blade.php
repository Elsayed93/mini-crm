...
@section('content')
    ...
    <x-content-header main-page="Employees" sub-page="Edit" route="employees" />
    <!-- /.content-header -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        id="inputphone" name="phone" value="{{ old('phone') ?? $employee->phone }}"
                                    ...
                                    <select name="company_id" id="companies"
                                        ...
                                        @foreach ($companies as $company)
                                            <option value="{{ $company->id }}"
                                                {{ old('company_id') ? (old('company_id') == $company->id ? 'selected' : '') : ($employee->company_id == $company->id ? 'selected' : '') }}>
                                                {{ $company->name }}
                                            </option>
                                        @endforeach
                                    </select>
